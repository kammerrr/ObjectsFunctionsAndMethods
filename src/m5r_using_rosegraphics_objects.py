...
#              The middle both vertically and horizontally
#
...
#            It draws the objects into the window, and allows a pause to be added as a parameter
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            Yes otherwise the window will close instantly
#
